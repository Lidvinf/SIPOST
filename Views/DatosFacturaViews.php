                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    ...
                                    <?PHP
                                                ...
                                                foreach ($datafactura as $datosUsuarioFactura) {
                                    ...
                                    ?>
                                                ...
                                                <td>
                                                <a href="#a<?php echo $datosUsuarioFactura['iddatos']; ?>" role="button" class="btn btn-success" data-toggle="modal">
                                                    <i class="icon_check_alt2"></i> </a>
                                             
                                            </td>
                                        </tr>

                                        <div id="a<?php  echo $datosUsuarioFactura['iddatos']; ?>" class="modal fade"
