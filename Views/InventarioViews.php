                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    foreach ($allactivo as $product ) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#a<?php echo $product['idactivo']; ?>" role="button"
                                   class="btn btn-success" data-toggle="modal">
                                    <i class="icon_check_alt2"></i> </a>
                                <a href="RegistroActivo.php?idborrar=<?PHP echo $product['idactivo']; ?>&usuarioLogin=<?PHP echo $usuario; ?>&passwordLogin=<?PHP echo $password; ?>"
                                   role="button" class="btn btn-danger"> <i class="icon_close_alt2"></i>
                                </a>
                            </td>
                        </tr>

                        <div id="a<?php echo $product['idactivo'] ?>" class="modal fade" tabindex="-1" role="dialog"
