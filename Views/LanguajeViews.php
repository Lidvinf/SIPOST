    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <section class="panel">
                        <header class="panel-heading"> Datos Lenguaje</header>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?PHP
                                    foreach (  $dataIdioma as $datosUsuarioLanguaje ) {
                                        ?>

                                        <tr>
                                            <td> <?PHP echo $datosUsuarioLanguaje['idioma']; ?></td>
                                            <td>
                                                <a href="#a<?php echo $datosUsuarioLanguaje['idIdioma']; ?>" role="button"
                                        ...
                                        <div id="a<?php echo $datosUsuarioLanguaje['idIdioma']; ?>" class="modal fade"
