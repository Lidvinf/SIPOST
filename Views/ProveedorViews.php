                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#a<?php echo $proveedor['idproveedor']; ?>" role="button"
                                               class="btn btn-success" data-toggle="modal">
                                                <i class="icon_check_alt2"></i> </a>
                                            <a href="RegistrosProveedor.php?idborrar=<?PHP echo $proveedor['idproveedor']; ?>&usuarioLogin=<?PHP echo $usuario; ?>&passwordLogin=<?PHP echo $password; ?>"
                                               role="button" class="btn btn-danger"> <i class="icon_close_alt2"></i>
                                            </a>
                                        </td>
                                    </tr>

                                    <div id="a<?php echo $proveedor['idproveedor']; ?>" class="modal fade" tabindex="-1"
