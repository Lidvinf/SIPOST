                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    foreach($allCliente as $client)
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#a<?php echo $client['idcliente']; ?>" role="button"
                                   class="btn btn-success" data-toggle="modal">
                                    <i class="icon_check_alt2"></i> </a>
                                <a href="RegistroCliente.php?idborrar=<?PHP echo $client['idcliente']; ?>&usuarioLogin=<?PHP echo $usuario; ?>&passwordLogin=<?PHP echo $password; ?>"
                                   role="button" class="btn btn-danger"> <i class="icon_close_alt2"></i>
                                </a>
                            </td>
                        </tr>

                        <div id="a<?php echo $client['idcliente']; ?>" class="modal fade" tabindex="-1"
